...
class TestSearch(unittest.TestCase):
    ...
    def test_add_todo(self):
        ...
        self.al.check("todo list contain 'buy some milk'")

    def test_complete_all_todos(self):
        self.al.do("type 'buy some milk' into the input field, then press 'Enter'")
        self.al.do("type 'buy some bread' into the input field, then press 'Enter'")
        self.al.check("buy milk' title font style is strikethrough", vision=True)
        self.al.check("buy bread' title font style is strikethrough", vision=True)